...
export function useDarkMode(setThemeState, keyLocalStorage) {
  // Use our useLocalStorage hook to persist state through a page refresh.
  // Read the recipe for this hook to learn more: usehooks.com/useLocalStorage
  const [enabledState, setEnabledState] = useLocalStorage(keyLocalStorage);
  ...
  useEffect(
    () => settingsDarkMode(setThemeState),
    [enabled, setThemeState] // Only re-call effect when value changes
  );
